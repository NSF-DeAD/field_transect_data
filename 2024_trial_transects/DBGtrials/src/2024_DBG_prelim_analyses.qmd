...
ggsave(filename = here("2024_trials_transects","DBG_trials","output", "LPI_toplayer.jpeg"), plot = TopLayer_plot, device = "jpeg", width = 4, height = 3)
```
...
ggsave(filename = here("2024_trials_transects","DBG_trials","output", "LPI_surfacelayer.jpeg"), plot = SoilSurface_plot, device = "jpeg", width = 4, height = 3)
```
...
ggsave(filename = here("2024_trials_transects","DBG_trials","output", "BeltTran.jpeg"), plot = BeltTran_plot, device = "jpeg", width = 4, height = 3)
```
...
ggsave(filename = here("2024_trials_transects","DBG_trials","output", "Gap.jpeg"), plot = Gap_plot, device = "jpeg", width = 4, height = 3)
```
...
Basal_plot <- ggplot(BasalInt_summary, aes(x = InterceptType,
  ...
  theme_minimal()
Basal_plot
ggsave(filename = here("2024_trials_transects","DBG_trials","output", "Basal.jpeg"), plot = Basal_plot, device = "jpeg", width = 4, height = 3)
```
...
litter_scatter_plot
ggsave(filename = here("2024_trials_transects","DBG_trials","output", "Basal_v_litter.jpeg"), plot = litter_scatter_plot, device = "jpeg", width = 4, height = 3)
```
