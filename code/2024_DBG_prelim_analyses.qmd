...
# load dataframes
BeltTran_df <- read_csv("240605_BeltTran.csv")
BasalIntercept_df <- read_csv("240605_BasalIntercept.csv")
Gap_df <- read_csv("240605_Gap.csv")
LPI_df <- read_csv("240605_LPI.csv")
```
...
ggsave(filename = "LPI_toplayer.jpeg", plot = TopLayer_plot, device = "jpeg", width = 4, height = 3)
```
...
ggsave(filename = "LPI_surfacelayer.jpeg", plot = SoilSurface_plot, device = "jpeg", width = 4, height = 3)
```
...
ggsave(filename = "BeltTran.jpeg", plot = BeltTran_plot, device = "jpeg", width = 4, height = 3)
```
...
ggsave(filename = "Gap.jpeg", plot = Gap_plot, device = "jpeg", width = 4, height = 3)
```
...
Basal_plot <- ggplot(BasalInt_summary, aes(x = InterceptType,
  ...
  theme_minimal()
Basal_plot
ggsave(filename = "Basal.jpeg", plot = Basal_plot, device = "jpeg", width = 4, height = 3)
```
...
litter_scatter_plot
ggsave(filename = "Basal_v_litter.jpeg", plot = litter_scatter_plot, device = "jpeg", width = 4, height = 3)
```
