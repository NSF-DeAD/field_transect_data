...
# 2024-06-05 data
BeltTran_20240605 <- read.csv("https://www.dropbox.com/scl/fi/b01um3zui9bo4h7ledotq/240605_BeltTran.csv?rlkey=kjtv84lznakci4bd8hv4t7xp8&dl=1")
BasalIntercept_20240605 <- read.csv("https://www.dropbox.com/scl/fi/p4e620d0idm03xw0zk9x3/240605_BasalIntercept.csv?rlkey=guoqzg4xq4el1x8u4c7wpinki&dl=1")
...
Top_v_Surface_plot <- ggplot(Top_v_Surface_sum, aes(x = SoilSurface,
  ...
  ggtitle("Soil Surface Hits by Top Layer\nNeed to change from total hits to percent") +
  facet_grid(rows = vars(TopLayer)) +
  theme_minimal()
Top_v_Surface_plot
```
